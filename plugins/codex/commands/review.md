...
Execution mode:
- Always launch the review in a Claude background task, whether invoked by the user or by Claude.
- Start immediately without asking the user or estimating review size.
- Run in the background even if the raw arguments include `--wait`.
