...
In `codex:codex-agent`, use write mode for implementation or fix assignments. Keep diagnosis, planning, research, and review assignments read-only unless the assignment also authorizes edits.
